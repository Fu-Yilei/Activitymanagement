...
<div class="header">
    ...
    String url="jdbc:mysql://localhost:3306/Activitymanagement";
    String user="root";
    String password="wr19950705";
    Connection conn;
    try{
   ...
   <% String title=rs.getString("title"); %>
    <a href="<s:url action="detail">  <s:param name="title" value="#title"/> </s:url>"><B>Details</B></a>
	</tr>
